MVP: Integrating openAI API to provide course recommendations based on the user’s preferences, in addition to developing both the front-end and back-end
